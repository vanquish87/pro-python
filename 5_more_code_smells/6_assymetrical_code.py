...
Smell 6:
assymetrical code
look at  get_info_str() n  to_string() 
they are just __str__ type stuff

__str__ to use at human readable - FOR USERS
__repr__ to use to represent a object - FOR DEVELOPERS
"""
