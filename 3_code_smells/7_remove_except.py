...
"""
Smell 7:
if Exception block is not doing anything than
there is no point of having it since is blocking python in general to find error if any

Remove it asap! in payout_holiday()
"""
