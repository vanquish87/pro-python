...
Smell 1:
Too many parameters
also 'feature envy' class doesn't need to know more detail than it needs
which means they could be merged or split in different units

changed add_vehicle_model_info() method and fuel_type, launch_year
"""
...
class VehicleModelInfo:
    ...
    model: str
    catalogue_price: int
    # adding default values here as per code smell 1
...
class VehicleRegistry:
    ...
    def add_vehicle_model_info(self, model_info: VehicleModelInfo) -> None:
        ...
        self.vehicle_models.append(
            VehicleModelInfo(
                model_info.brand, model_info.model, model_info.catalogue_price, model_info.fuel_type, model_info.launch_year
            )
        )
